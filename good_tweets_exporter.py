...
try:
    ...
    # Выполнение запроса
    cursor.execute("SELECT `id`, `tweet_text`, `original_tweet_text`, `url` FROM `tweets` WHERE `good`")
    ...
    print(f"Найдено всего {total_tweets} 'хороших' твитов")
    ...
    for file_index in range(num_files):
        ...
        filename = f"good_tweets_{current_time}_part{file_index+1}.txt"
